...
If you're on another distro and you want to be able to follow these instructions specifically, see the [Linux (Other)](./rav1ator-cli.mdx/#linux-other) section.
