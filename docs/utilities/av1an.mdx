...
You will need Python, [FFmpeg](/docs/filtering/ffmpeg) and [Vapoursynth](/docs/filtering/Vapoursynth) to be installed regardless of your current operating system.
## Installation
