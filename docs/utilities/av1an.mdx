...
- Rust
- Python (Required for [Vapoursynth](/docs/filtering/vapoursynth.mdx), currently needs 3.11, this may change in the future so consult from [their website](http://www.vapoursynth.com/doc/installation.html))
- FFmpeg
