...
While JPEG is certainly not the most state of the art lossy image codec compared to its newer and (usually) better successors like JPEG-XL (an actual direct successor) & [AVIF](../images/AVIF.mdx), it enjoys near universal compatibility with (likely) most utilities you would work with in your everyday life that have anything to do with images.