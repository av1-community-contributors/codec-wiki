...
XPSNR is a distortion measurement algorithm for video quality assessment, based on the concept of the peak signal to noise ratio (PSNR), tuned to better reflect the human visual system.
...
The reference implementation by Fraunhofer HHI is a [FFmpeg 7.0 plug-in](https://github.com/fraunhoferhhi/xpsnr), and there is a [community-built standalone implementation](github.com/gianni-rosato/sxpsnr) available as well.
