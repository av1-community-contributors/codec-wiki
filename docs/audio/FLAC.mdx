...
:::caution
It is not recommended to transcode a lossily encoded file to FLAC as the file size will grow greatly, however any sustained loss will be retained. FLAC is best if you need to retain the audio exactly as it is.
:::
## Software support
