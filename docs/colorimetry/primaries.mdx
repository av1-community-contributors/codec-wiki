...
If you have a video with an unset color primaries, it is safer to assume BT.709 by default. Videos which are BT.2020 should already have their color metadata set.
