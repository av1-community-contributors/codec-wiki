...
<Tabs>
    <TabItem value="unixlike" label="Linux & macOS">
        ...
        There is an FFmpeg fork called [FFmpeg-VVC](https://github.com/MartinEesmaa/FFmpeg-VVC). It is maintained by Martin Eesmaa, who is the author of the [VVCEasy](https://github.com/MartinEesmaa/VVCEasy) GitHub repo featuring guides and more general information about working with VVC.
