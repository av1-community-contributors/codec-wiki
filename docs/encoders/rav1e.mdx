...
Here are instructions for resetting to release 0.7.0 (latest as of 30 Dec 2023). Omit the `git reset` command to use the latest git, if you have a *specific* reason to use the latest git instead of an official tagged release.

```bash
git clone https://github.com/xiph/rav1e.git
cd rav1e
git reset --hard c4603c75dc593c1ad7c4b6a741e22bd3ea602be5
