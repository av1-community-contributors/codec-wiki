...
If you are interested in reading more about the project, you can visit [the project's website](https://svt-av1-psy.com/) for more information. The repository was archived by the owner on Apr 30, 2025. It is now read-only and the author officially [announced](https://github.com/psy-ex/svt-av1-psy/blob/master/README.md) the actual end of SVT-AV1-PSY. A fork of the project, [svt-av1-psyex](https://github.com/BlueSwordM/svt-av1-psyex), is developed by BlueSwordM and is referred from the author from the same announcement.
